...
import { allpropdataactions } from "../../../../Home/redux/action";
...
const Property: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await Apis.get("/property/getAllProperty");
            ...
            <div className="row">
              <div className="col-lg-6 col-md-6 col-sm-6">
                {propertyArray.length > 0
                  ? propertyArray.map(
                      (item: any, i: any) =>
                        item.property_owner._id === userId && (
                            ...
                            <div className="course-meta">
                              ...
                              <div className="prise row">
                                ...
                                <div className="col-lg-4 mt-2 ">
                                  <span>
                                    <b>
                                      <span>₹</span>  {item?.property?.expected_price}
                                    </b>
                                  </span>
                                </div>
                              </div>
