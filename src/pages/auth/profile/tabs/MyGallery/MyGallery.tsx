...
const Gallery = (props: Album) => {
  const [activeTab, setActiveTab] = useState("album");
  const [selectedAlbum, setSelectedAlbum] = useState<number | null>(null);
  // const [albumImages, setAlbumImages] = useState<string[]>([]);
  const [albums, setAlbums] = useState<Album[]>(generateAlbums());
                    ...
                    >
                      <div className="album-square">
                        <div className="album-row">
                          {album.images.slice(0, 2).map((image, imageIndex) => (
                            <img
                              key={imageIndex}
                              src={room}
                        ...
                        <div className="album-row">
                          {album.images.slice(2, 4).map((image, imageIndex) => (
                            <img
                              key={imageIndex}
                              src={room}
