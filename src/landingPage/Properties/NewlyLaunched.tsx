                ...
                <div className="col-lg-10" style={{ marginTop: "-80px" }}>
                  ...
                  >
                    <div style={{ display: "flex", marginBottom: "-60px" }}>
                      <SwiperSlide>
                        <div className="blog-posts col-lg-8 col-sm-12 col-md-12">
                          <figure>
                          ...
                          >
                            <label
                              style={{ fontSize: "18px", fontWeight: "400", lineHeight:"0px", paddingTop:"25px" }}
                            >
                              Sreenidhi Serengeti
                            </label>
                            <label>Telangana, Hyderabad</label>
                            <h6>69.56 L to 1.5 Cr</h6>
